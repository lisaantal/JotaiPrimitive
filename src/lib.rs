// src/lib.rs
/*
 * Core library for JotaiPrimitive
 */
...
#[derive(Debug)]
pub struct JotaiPrimitiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JotaiPrimitiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JotaiPrimitive processing");
    
    let mut processor = JotaiPrimitiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JotaiPrimitiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JotaiPrimitiveProcessor::new(false);
